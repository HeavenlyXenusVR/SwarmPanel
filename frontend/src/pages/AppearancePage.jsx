    ...
    >
      <section className="settings-grid appearance-layout">
        <form className="panel form-panel appearance-form" onSubmit={save}>
          ...
          <div className="appearance-cluster">
            ...
            <div className="three-col">
              ...
              <label className="field color-field color-field-wide"><span>Accent</span><input type="color" value={draft.accent_color || "#89b4fa"} onChange={(event) => update("accent_color", event.target.value)} /></label>
        ...
        <aside className={`panel appearance-preview panel-shape-${draft.card_shape || "soft"} panel-density-${draft.density || "comfortable"} panel-tabs-${draft.tab_style || "rail"}`} style={panelStyle(draft)}>
          ...
          <p className="appearance-preview-note">Live sample of the command deck with your current layout, card language, and surface treatment.</p>
